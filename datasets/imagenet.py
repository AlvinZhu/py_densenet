...
def index_all(dataset_path):
    ...
    label_names = [imagenet_metadata[x] for x in label_names]
...
class ImageNet(object):
    def __init__(self, dataset_path, image_shape=(224, 224, 3), num_threads=8, batch_size=128,
    ...
    def read_image_func(self, filename, label):
        ...
        image_decoded = tf.image.decode_jpeg(image_string, channels=self.image_shape[2])
...
def main_prepare_dataset():
    ...
    imagenet = ImageNet('/backups/work/ILSVRC2017/ILSVRC', read=False)
...
def main():
    ...
    imagenet = ImageNet('/backups/work/ILSVRC2017/ILSVRC', shuffle=False, normalize=False, augment=True)
    ...
    with tf.Session() as sess:
        ...
        for image, label in zip(images, labels):
            print(imagenet.label_names[label])
